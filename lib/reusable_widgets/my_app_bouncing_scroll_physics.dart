...
class MyAppBouncingScrollPhysics extends ScrollPhysics {
  /// Creates scroll physics that bounce back from the edge.
  const MyAppBouncingScrollPhysics({
  ...
  @override
  MyAppBouncingScrollPhysics applyTo(ScrollPhysics? ancestor) {
    return MyAppBouncingScrollPhysics(
  ...
  double frictionFactor(double overscrollFraction) {
    switch (decelerationRate) {
      ...
      case ScrollDecelerationRate.normal:
        return 0.05 * math.pow(1 - overscrollFraction, 2);
    }
  }
